...
const Hero = () => {
    ...
    return (
      ...
      {/* navbar  started*/}
        <div className="px-4 mb-96 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
  ...
  {/* navbar closed */}
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-lg">
            ...
            <button className=" talkBtn btn bg-white border-0  rounded-full">Let's Talk!</button>
          </div>
        </div>
      </div>
    );
